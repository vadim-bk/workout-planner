...
export function ImportHistoryPage() {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      setImportResult({
        success: false,
        message: `❌ Помилка: ${error.message || "Не вдалося імпортувати дані"}`,
      });
    } finally {
      setIsImporting(false);
    }
        ...
        <Alert>
          ...
          <AlertDescription>
            ...
            <ul className="list-disc list-inside space-y-1 text-sm">
              ...
              <li>
                Більше даних = точніші підказки для нових тренувань
              </li>
              <li>
                Можна імпортувати декілька разів (дані додаються, не заміняються)
              </li>
            </ul>
          </AlertDescription>
        </Alert>
          ...
          <CardContent>
            <div className="space-y-4 text-sm">
              <div>
                ...
                <p className="text-muted-foreground mt-1">
                  Або просто: <code className="bg-muted px-1">15.10.2024</code>
                </p>
              </div>
              ...
              <div>
                <p className="font-semibold mb-1">🏋️ Підходи:</p>
                <code className="bg-muted px-2 py-1 rounded block mb-1">
                  Підхід 1: 100 кг × 12 повторень
                </code>
                <code className="bg-muted px-2 py-1 rounded block">
                  Підхід 2: 12 повторень
                </code>
                <p className="text-muted-foreground mt-1">
                  (Вага опціональна, якщо вправа без обтяження)
                </p>
              </div>
              ...
              <div className="pt-4 border-t">
                ...
                <ul className="list-disc list-inside space-y-1 text-muted-foreground">
                  <li>Розділяйте різні тренування порожніми рядками або "---"</li>
